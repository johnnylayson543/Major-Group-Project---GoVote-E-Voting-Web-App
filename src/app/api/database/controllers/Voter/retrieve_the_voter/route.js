...
import { retrieve_the_voter_voter_type } from "../../../../Forms/Voter/retrieve_the_voter_voter_type";
...
export async function GET(req, res) {
  ...
  const x = obj;
  const xy = {fn: Voter.retrieve_the_voter, par: x};  // This is where you send the Model.function_name, object. 
